...
class SelectorConfigCustom {
  /// [selectorType], for selector button type
  final PhoneInputSelectorTypeCustom selectorType;
  ...
  const SelectorConfigCustom({
    this.selectorType = PhoneInputSelectorTypeCustom.DROPDOWN,
    this.showFlags = true,
    this.useEmoji = false,
